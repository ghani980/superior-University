# Employee.py-Abstract class for Employee
...
class Manager(Employee):
    ...
    def display_info(self):
        return f"Name: {self.get_name()}, Age: {self.get_age()}, Salary: {self.get_salary()}, Department: {self.get_department()}"

#Worker.py: Inherits from Employee
...
class Worker(Employee):
    ...
    def display_info(self):
        return f"Name: {self.get_name()}, Age: {self.get_age()}, Salary: {self.get_salary()}, Hours Worked: {self.get_hours_worked()}"

#EmployeeManagement.py: File handling functions
...
from Manager import Manager
from Worker import Worker
from EmployeeManagement import read_employee_data, add_employee_data, update_employee_data, delete_employee_data
